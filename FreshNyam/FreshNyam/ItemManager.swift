...
class ItemManager: ObservableObject {
    ...
    func scheduleNotification(for item: Item) {
           ...
           let triggerDate = Calendar.current.dateComponents([.year, .month, .day, .hour, .minute, .second],
                                                             from: item.expiryDate.addingTimeInterval(-60)) //1분 전으로 설정
...
//저장된 이미지 불러오기
        images = [
            "간식": ["감자칩","곰젤리","과자", "과자류", "나초","마시멜로우", "사탕", "사탕 2","젤리","젤리2","초콜릿","초콜릿2", "크래커", "팝콘"],
            ...
            "소스": ["고추장", "꿀 1", "꿀 2", "꿀", "마요네즈", "머스타드", "사과잼", "소스 1", "소스", "시럽 1", "시럽", "식초", "일회용 소스", "잼 1", "잼", "칠리소스", "피넛버터"],
            "약": ["알약", "약 1", "약","비타민C"],
            ...
            "향신료,조미료": ["고추냉이", "시나몬","시나몬 1",  "바닐라","발사믹 식초", "오일","올리브오일", "조리유 1", "조리유", "조미료", "코코넛오일",  "msg", "식용색소", ]
        ]
    }
